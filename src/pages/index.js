...
const Index = () => {
  const mantra = [
    {
      topic: `Innovation`,
      body: `Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat.`,
    ...
    <>
      <div className="space-y-20">
        ...
        <section className="w-full pb-6 space-y-8 text-gray-700 lg:px-16 xl:px-28">
          ...
          <div className="flex flex-wrap items-center justify-center space-y-7 md:space-y-0">
            {mantra.map((mant, i) => (
              <div
                key={i}
                className="flex flex-col items-center justify-center w-3/5 mx-auto md:w-3/12 des-con"
              >
                <div className="inline-flex justify-center px-auto">{mant.icon}</div>
                <h4 className={`text-3xl font-bold`}>{mant.topic}</h4>
        ...
        {/* learn a skill */}
        <section id="learn-skill-container" className="px-8 bg-gray-200 sm:px-12 lg:px-16 xl:px-36">
            ...
            <div className="w-full max-w-[1500px] py-16 md:py-20">
              <div className="flex items-center flex-col md:flex-row justify-center mx-auto md:justify-between w-full max-w-[1500px] md:space-x-10 space-y-12 md:space-y-0">
                <div className="text-center md:text-left w-[80%] mx-auto">
                  ...
                  <p className="py-10 text-lg font-medium leading-5 text-secondary">
        ...
        {/* Hive News */}
        <section className="px-8 py-10 space-y-10 bg-gray-200 sm:px-12 lg:px-16 xl:px-28">
          <div className="flex items-center justify-center text-3xl font-bold md:text-5xl">
